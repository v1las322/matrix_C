...
void s21_auto_recording(double number, matrix_t *A) {
...
START_TEST(s21_eq_matrix_1) {
  ...
  s21_auto_recording(1.0, &A);

  s21_create_matrix(3, 2, &B);
  s21_auto_recording(1.0, &B);
...
START_TEST(s21_eq_matrix_4) {
  ...
  s21_create_matrix(3, 2, &A);
  s21_auto_recording(10.0, &A);

  s21_create_matrix(3, 2, &B);
  s21_auto_recording(-10.0, &B);
...
START_TEST(s21_sum_matrix_3) {
  ...
  s21_create_matrix(4, 4, &A);
  s21_auto_recording(-3.0, &A);

  s21_create_matrix(4, 4, &B);
  s21_auto_recording(5.0, &B);
